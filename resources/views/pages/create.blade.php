    ...
    <div class="card-body">
        <form method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="file" class="form-control {{ $errors->has('thumbnail') ? 'is-invalid' : '' }}" id="thumbnail"
                    placeholder="Attached Image" name="thumbnail" accept="image/png, image/jpeg, image/jpg">
                @error('thumbnail')
                <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
